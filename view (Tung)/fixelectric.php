<?php 
        ...
        if(isset($_POST['buttonSua'])){
            ...
            $sql="UPDATE servicebill SET room-id='$roomid', date='$date', electric-num-old='$electricnumold', electric-num-new='$electricnumnew' WHERE id='$id'";
    ...
    <form style="padding-top: 150px; padding-left:450px;" method="post" action="">
        ...
        ?>
            ...
            <tr>
                ...
                <td colspan="1">
                    <input type="text" name="txtelectricnumold" value="<?php echo $row['electric-num-old'] ?>" disabled>
                </td>
            </tr>
            <tr>
                <td colspan="1">Số điện mới :</td>
                <td colspan="1">
                    <input type="text" name="txtelectricnumnew" value="<?php echo $row['electric-num-new'] ?>" disabled>
                </td>
            </tr>
            <?php 
        }
