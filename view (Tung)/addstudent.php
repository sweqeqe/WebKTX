...
if (isset($_POST['buttonCapnhat'])) {
  ...
  // else
  // {
  $sql = "INSERT INTO student VALUES ('$id','$name','$gt','$phone','$address','$cccd','$class','$roomid','$bedid','$contractid')";
  ...
  <form action="" method="post">
    <div class="container">
      <ul style="padding-left: 150px;">
        ...
        <li><input type="radio" name="gender" value="Male">Nam<input type="radio" name="gender" value="Female">Nữ</li>
        <br>
        <li>Số diện thoại :</li>
        ...
        <br>
        <li><button name="buttonCapnhat" style="margin-right: 20px; width:100px; background-color:   rgb(128,218,235);"><a style="background-color:   rgb(128,218,235); color:white;" href="./addstudent.php">Cập nhật</a></button></li>
      </ul>
    </div>
  </form>
</body>
